...
@Entity(name = "metro_timetable_ver")
public class MetroTimeTableVer extends BaseEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "metro_trip_ver_id")
    private MetroTripVer trip;
    ...
    public MetroTripVer getTrip() {
        return trip;
    }

    public void setTrip(MetroTripVer trip) {
        this.trip = trip;
    }
