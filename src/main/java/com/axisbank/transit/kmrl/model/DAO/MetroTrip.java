...
@Entity(name = "metro_trip")
public class MetroTrip extends BaseEntity {
    ...
    public List<MetroTimeTable> getTimeTables() {
        return timeTables;
    }

    public void setTimeTables(List<MetroTimeTable> timeTables) {
