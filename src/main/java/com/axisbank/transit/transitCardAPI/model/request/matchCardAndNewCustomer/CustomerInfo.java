...
public class CustomerInfo {
    ...
    @JsonProperty("IsOtpCustomer")
    private String isOtpCustomer;
    ...
    public String getIsOtpCustomer() {
        return isOtpCustomer;
    }

    public void setIsOtpCustomer(String isOtpCustomer) {
        this.isOtpCustomer = isOtpCustomer;
    }
}
