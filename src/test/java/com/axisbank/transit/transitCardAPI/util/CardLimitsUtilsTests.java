...
public class CardLimitsUtilsTests extends BaseTest {

    @InjectMocks
    @Autowired
    CardLimitsUtils cardLimitsUtils;
    ...
    public void setUp() throws Exception {
        ...
        ReflectionTestUtils.setField(cardLimitsUtils, "secretKey", "xyz");
        ReflectionTestUtils.setField(cardLimitsUtils, "serviceReqId", "xyz");
        ReflectionTestUtils.setField(cardLimitsUtils, "channelId", "xyz");
    }
    ...
    public void getEncryptedReqPayloadTest() throws Exception {
        ...
        Assert.assertNotNull(cardLimitsUtils.getEncryptedReqPayload("abc", "xyz"));
    }
    ...
    public void addTypeResponseTest() throws Exception {
        ...
        Assert.assertNotNull(cardLimitsUtils.addTypeResponse(responseEntity, "TopupToPrepaidResponse"));
    }
}
