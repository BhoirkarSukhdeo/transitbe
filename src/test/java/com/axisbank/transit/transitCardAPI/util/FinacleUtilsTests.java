...
public class FinacleUtilsTests extends BaseTest {

    @InjectMocks
    @Autowired
    FinacleUtils finacleUtils;
    ...
    public void setUp() throws Exception {
        ...
        ReflectionTestUtils.setField(finacleUtils, "secretKey", "xyz");
        ReflectionTestUtils.setField(finacleUtils, "channelId", "xyz");
        ReflectionTestUtils.setField(finacleUtils, "checksumKey", "xyz");
        ReflectionTestUtils.setField(finacleUtils, "secretKey", "xyz");
    }
    ...
    public void getChecksumReqPayloadTest() throws Exception {
        ...
        Assert.assertNotNull(finacleUtils.getChecksumReqPayload("abc", "abc"));
    }
    ...
    public void getEncryptedReqPayloadTest() throws Exception {
        ...
        Assert.assertNotNull(finacleUtils.getEncryptedReqPayload("abc", "xyz"));
    }
    ...
    public void addTypeResponseTest() throws Exception {
        ...
        Assert.assertNotNull(finacleUtils.addTypeResponse(responseEntity, "TopupToPrepaidResponse"));
    ...
    public void addTypeResponseChecksumTest() throws Exception {
        String body = "{\n" +
                ...
                "  }";
        ResponseEntity<String> responseEntity = ResponseEntity.accepted().body(body);
        Assert.assertNotNull(finacleUtils.addTypeResponseChecksum(responseEntity));
    }
}
